					...
					<FormSection>
						...
						<DietSelectionContainer>
							<DietButton
								...
								variant="within"
								onPress={() =>
									setIsDiet(DietStatus.WITHIN_DIET)
								}
								disabled={loading}
							>
								<DietButtonText
									isSelected={
										isDiet === DietStatus.WITHIN_DIET
									}
									variant="within"
								>
									Dentro da Dieta
							...
							<DietButton
								...
								variant="outside"
								onPress={() =>
									setIsDiet(DietStatus.OUTSIDE_DIET)
								}
								disabled={loading}
							>
								<DietButtonText
									isSelected={
										isDiet === DietStatus.OUTSIDE_DIET
									}
									variant="outside"
								>
									Fora da Dieta
